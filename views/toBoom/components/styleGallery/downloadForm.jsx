...
export default class DownloadForm extends React.Component {
     ...
     @computed get get_formState(){ return this.props.store.styleGalleryStore.formState }
        ...
        frontBinder = (event) =>{
             let target = event.target,
                 ...
                 formState = mobx.toJS( this.props.store.styleGalleryStore.formState );
              if( checked ){
                  formState = Object.assign(formState, { fpngDisable : false, fepsDisable : formState.checkboxSource.master_annex == 1 ? false : true,  front : true })
              }else{
        ...
        reverseBinder = (event) =>{
                let target = event.target,
                    ...
                    formState = mobx.toJS( this.props.store.styleGalleryStore.formState );
                        if( checked ){
                            formState = Object.assign(formState, { rpngDisable : false, repsDisable : formState.checkboxSource.drawing_annex == 1 ? false : true, reverse : true } );
                        }else{
