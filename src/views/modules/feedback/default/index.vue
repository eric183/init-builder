<template>
    ...
    <div class="mod-user">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataListFun()" size="small">
            <el-form-item label="账号:"> <el-input v-model="dataForm.userAccount" placeholder="请输入反馈人账号" clearable></el-input> </el-form-item>
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
            ...
            <el-table-column prop="feedbackAt" header-align="center" align="center" :formatter="feedbackAt" :show-overflow-tooltip="true" label="反馈时间"> </el-table-column>
...
export default {
    data() {
        return {
            dataForm: {
                ...
                startTime: '',
                endTime: '',
                origin: 1, //来源用户app  对应运营后台的意见反馈页面
            },
    ...
    methods: {
        ...
        // 后端返回的数字，转换成中文
        feedbackAt(item) {
            return commonFunc(item.feedbackTime);
        },
    },
};
</script>
