<template>
    <div class="mod-schedule">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()" size="small">
            <el-form-item> <el-input v-model="dataForm.beanName" placeholder="bean名称" clearable></el-input> </el-form-item>
            <el-form-item>
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column fixed="right" header-align="center" align="center" width="380" label="操作">
                <template slot-scope="scope">
                    <el-button plain v-if="isAuth('sys:schedule:update')" type="success" size="mini" @click="addOrUpdateHandle(scope.row.jobId)">修改</el-button>
                    <el-button plain v-if="isAuth('sys:schedule:delete')" type="danger" size="mini" @click="deleteHandle(scope.row.jobId)">删除</el-button>
                    <el-button plain v-if="isAuth('sys:schedule:pause')" type="success" size="mini" @click="pauseHandle(scope.row.jobId)">暂停</el-button>
                    <el-button plain v-if="isAuth('sys:schedule:resume')" type="success" size="mini" @click="resumeHandle(scope.row.jobId)">恢复</el-button>
                    <el-button plain v-if="isAuth('sys:schedule:run')" type="success" size="mini" @click="runHandle(scope.row.jobId)">立即执行</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
