...
import personAdd from '@/views/modules/faceDevice/person-add-device';
import personDele from '@/views/modules/faceDevice/person-dele-device';
import personEdit from '@/views/modules/faceDevice/personEdit';
import {faceurlMkdir} from '@/assets/imgjs.js';
export default {
    components: {
        ZZTable,
        FormTable,
