    ...
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px" size="small">
            ...
            <el-form-item label="上级菜单">
                <el-popover ref="menuListPopover" placement="top-start" trigger="click">
                    <el-tree
                        :data="menuList"
            ...
            <el-form-item v-if="dataForm.type === 3" label="菜单路由" prop="url"> <el-input v-model="dataForm.url" placeholder="菜单路由"></el-input> </el-form-item>
            <el-form-item v-if="dataForm.type !== 2" label="授权标识" prop="perms">
                <el-input v-model="dataForm.perms" placeholder="多个用逗号分隔, 如: user:list,user:create"></el-input>
            </el-form-item>
            <el-form-item v-if="dataForm.type !== 4" label="排序号" prop="orderNum">
                <el-input-number v-model="dataForm.orderNum" controls-position="right" :min="0" label="排序号"></el-input-number>
            </el-form-item>
            <el-form-item v-if="dataForm.type !== 4" label="菜单图标" prop="icon">
                <el-row>
                    <el-col :span="22">
            ...
            this.$http({
                ...
                .then(() => {
                    if (!this.dataForm.id) {
                        ...
                        // 修改
                        this.$http({
                            url: this.$http.adornUrl(`/v1/auth/sysMenus/` + this.dataForm.id),
                            method: 'get',
                        }).then(({data}) => {
                            console.log(data);
