<template>
    ...
    <div class="mod-user">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
            ...
            <el-table-column prop="opinionType" header-align="center" align="center" :formatter="opinionType" label="类型"> </el-table-column>
            <el-table-column prop="createdAt" header-align="center" :formatter="createdAt" align="center" width="140" label="反馈时间"> </el-table-column>
