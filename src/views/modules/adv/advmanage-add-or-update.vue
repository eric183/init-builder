...
import {advertisements} from '@/assets/imgjs.js';
import newUpload from '../UIModules/NEWUpload';
var co = require('co');
                ...
                if (this.dataForm.id) {
                    this.$http({
                        ...
                        if (data && data.code === 200) {
                            ...
                            this.dataForm.startAt = commonFunc.commonFunc(data.data.startAt);
                            //console.log(this.dataForm.startAt)
                            this.dataForm.endAt = commonFunc.commonFunc(data.data.endAt);
