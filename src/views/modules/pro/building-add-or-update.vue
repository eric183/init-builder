    ...
    <div>
        ...
        >
            ...
            >
                ...
                <el-form-item label="楼栋简介" prop="abbreviation">
                    <el-input v-model="dataForm.abbreviation" placeholder="楼栋简介"></el-input>
                </el-form-item>
                ...
                <el-form-item label="楼栋地址" prop="address">
                    <el-input v-model="dataForm.address" placeholder="楼栋地址"></el-input>
                </el-form-item>
                ...
                <el-form-item label="最低楼层" prop="lowestFloor">
                    <el-input v-model="dataForm.lowestFloor" placeholder="最低楼层"></el-input>
                </el-form-item>
                <el-form-item label="最高楼层" prop="highestFloor">
                    <el-input v-model="dataForm.highestFloor" placeholder="最高楼层"></el-input>
                </el-form-item>
                <el-form-item label="建筑面积(m2)" prop="totalArea">
                    <el-input v-model="dataForm.totalArea" placeholder="建筑面积"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button
                        type="success"
        ...
        <el-dialog title="楼层对应关系" :visible.sync="dialogdoorrelative">
            <ul class="doorlistblock">
                ...
                <li v-for="(item, index) in floorlist" :key="index">
                    <span>{{ index + 1 }}</span>
                    <span>
                        <!-- modified by ericKuang -->
                        
                        <input type="text" v-model="item.actualFloorNo">
                        <!-- <input type="text" v-model="item.actualFloorNo" :value="item.actualFloorNo" /> -->
                    </span>
                    <span>
                        <!-- modified by ericKuang -->
            ...
            <ul class="doorlistblock">
                ...
                <li v-for="(item, index) in floorInfolist" :key="index">
                    ...
                    <span>
                        <input
                            type="text"
                            v-model="item.actualFloorNo"
                            @blur="isActiveChange(item)"
                        >
                    </span>
                    <span>
                        <input
    ...
    methods: {
                ...
                if (this.dataForm.buildingId) {
                    ...
                    this.$http({
                        url: this.$http.adornUrl(
                            `/v1/building/buildings/${this.dataForm.buildingId}`
                        ),
                        method: "get",
        ...
        getDoorTable() {
            ...
            if (this.dataForm.buildingId) {
                ...
                this.floorlist = [];
                var number =
                    this.dataForm.highestFloor - this.dataForm.lowestFloor;
                for (
                    let i = this.dataForm.lowestFloor;
                    i <= this.dataForm.highestFloor;
                    i++
                ) {
                    if (i == 0) {
                        continue;
