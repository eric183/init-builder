...
import {superdevices} from '@/assets/imgjs.js';
var co = require('co');
        ...
        getDeviceInfo() {
            this.$http({
                ...
                if (data && data.code === 200) {
                    ...
                    this.dataForm.installationTime = commonFunc.commonFunc(data.data.installationTime);
                    ...
                    this.dataForm.expirationTime = commonFunc.commonFunc(data.data.expirationTime);
