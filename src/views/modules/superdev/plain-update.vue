        ...
        getDataInfo() {
            this.$http({
                ...
                if (data && data.code === 200) {
                    ...
                    this.dataForm.startTime = commonFunc.commonFunc(data.data.plan.startTime);
                    this.dataForm.endTime = commonFunc.commonFunc(data.data.plan.endTime);
                    this.dataForm.firstExecuteTime = commonFunc.commonFunc(data.data.plan.firstExecuteTime);
