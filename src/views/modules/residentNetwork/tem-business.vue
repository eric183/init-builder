...
import {businessType, operatorType, businessStatus} from './network.js';
export default {
    components: {
        add,
    },
    ...
    methods: {
        ...
        openingTime(item) {
            return commonFunc.commonFunc(item.openingTime);
        },
        stoppingTime(item) {
            return commonFunc.commonFunc(item.stoppingTime);
        },
    },
