                ...
                <div class="list-count">
                    <div class="li-count">
                        ...
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ fineFood.foodOrderNum }}</h3>
                    ...
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe61e;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ fineFood.foodRevenue }}</h3>
                    ...
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe64f;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ fineFood.foodItemNum }}</h3>
                    ...
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe603;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ fineFood.foodDiscount }}</h3>
            ...
            <div class="item-count">
                ...
                <div class="list-count">
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe667;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ superProduct.mallOrderNum }}</h3>
                            <h4 class="count-titinfo">订单数</h4>
                        </div>
                    </div>
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe61e;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ superProduct.mallRevenue }}</h3>
                            <h4 class="count-titinfo">营收金额(元)</h4>
                        </div>
                    </div>
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe64f;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ superProduct.mallItemNum }}</h3>
                            <h4 class="count-titinfo">商品数量</h4>
                        </div>
                    </div>
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe603;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ superProduct.mallDiscount }}</h3>
                            <h4 class="count-titinfo">优惠金额(元)</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="item-count">
                ...
                <div class="list-count">
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe601;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ appDataList.newUser }}</h3>
            ...
            <div class="item-count">
                ...
                <div class="list-count">
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe601;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ userCount.newRegisteredUser }}</h3>
            ...
            <div class="item-count">
                ...
                <div class="list-count">
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe601;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ expressPayment.expressOrderNum }}</h3>
                    ...
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe64f;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ expressPayment.expressRevenue }}</h3>
                    ...
                    <div class="li-count">
                        <div class="left-count"><i class="iconfont">&#xe64f;</i></div>
                        <div class="right-count">
                            <h3 class="count-numinfo">{{ expressPayment.expressDispatchNum }}</h3>
